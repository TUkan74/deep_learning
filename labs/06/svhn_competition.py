...
parser.add_argument("--backbone_learning_rate", default=5e-5, type=float, help="Backbone learning rate during finetuning.")
...
parser.add_argument("--epochs", default=2, type=int, help="Number of frozen-backbone epochs.")
parser.add_argument("--finetune_epochs", default=18, type=int, help="Number of full finetuning epochs.")
parser.add_argument("--gradient_clip_norm", default=10.0, type=float, help="Gradient clipping norm.")
parser.add_argument("--image_size", default=384, type=int, help="Image size used by the detector transform.")
parser.add_argument("--learning_rate", default=5e-4, type=float, help="Detector head learning rate.")
...
parser.add_argument("--model_name", default="fasterrcnn_resnet50_fpn_v2", type=str, help="Torchvision detector name.")
...
parser.add_argument("--raw_detections_per_image", default=20, type=int, help="Number of raw detections kept before tuned filtering.")
parser.add_argument("--score_threshold", default=0.35, type=float, help="Fallback score threshold used before tuning.")
